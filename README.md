...
| ------- | ------------------ | ----- | ------------ |
| [RepoDb.Connector.AuroraDb.MySqlConnector](src/RepoDb.Connector.AuroraDb.MySqlConnector) | Amazon Aurora MySQL (via the [AWS Advanced .NET Data Provider Wrapper](https://github.com/aws/aws-advanced-dotnet-data-provider-wrapper) and MySqlConnector) | [![NuGet](https://img.shields.io/nuget/v/RepoDb.Connector.AuroraDb.MySqlConnector.svg)](https://www.nuget.org/packages/RepoDb.Connector.AuroraDb.MySqlConnector) | [![Build](https://img.shields.io/github/actions/workflow/status/mikependon/RepoDB.Connectors/build-auroradb-mysqlconnector.yml?branch=main&label=build)](https://github.com/mikependon/RepoDB.Connectors/actions/workflows/build-auroradb-mysqlconnector.yml) |
| [RepoDb.Connector.AuroraDb.Npgsql](src/RepoDb.Connector.AuroraDb.Npgsql) | Amazon Aurora PostgreSQL (via the [AWS Advanced .NET Data Provider Wrapper](https://github.com/aws/aws-advanced-dotnet-data-provider-wrapper) and Npgsql) | [![NuGet](https://img.shields.io/nuget/v/RepoDb.Connector.AuroraDb.Npgsql.svg)](https://www.nuget.org/packages/RepoDb.Connector.AuroraDb.Npgsql) | [![Build](https://img.shields.io/github/actions/workflow/status/mikependon/RepoDB.Connectors/build-auroradb-npgsql.yml?branch=main&label=build)](https://github.com/mikependon/RepoDB.Connectors/actions/workflows/build-auroradb-npgsql.yml) |
