...
{
    /// <summary>
    /// Represents a parameter to a <see cref="EDBCommand"/>.
    /// </summary>
    public class EDBParameter : DbParameter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EDBParameter"/> class from an existing <see cref="NpgsqlParameter"/>.
        /// </summary>
        /// <param name="parameter">The underlying <see cref="NpgsqlParameter"/> to wrap.</param>
        internal EDBParameter(NpgsqlParameter parameter)
        {
        ...
        /// <summary>
        /// Gets or sets the <see cref="EDBType"/> of the parameter.
        /// </summary>
        public EDBType EDBType
        {
            get => EDBTypeConverter.ToEDBType(_parameter.NpgsqlDbType);
            set => _parameter.NpgsqlDbType = EDBTypeConverter.ToNpgsqlDbType(value);
        }
