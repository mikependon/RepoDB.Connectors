...
{
    /// <summary>
    /// Provides a means of reading a forward-only stream of rows from an EnterpriseDB database.
    /// </summary>
    public class EDBDataReader : DbDataReader
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EDBDataReader"/> class.
        /// </summary>
        /// <param name="reader">The underlying <see cref="NpgsqlDataReader"/> to wrap.</param>
        internal EDBDataReader(NpgsqlDataReader reader)
        {
            _reader = reader;
        }
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="EDBDataReader"/> contains one or more rows.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of fields in the <see cref="EDBDataReader"/> that are not hidden.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="DataTable"/> that describes the column metadata of the <see cref="EDBDataReader"/>.
        /// </summary>
        ...
        /// <summary>
        /// Advances the <see cref="EDBDataReader"/> to the next record.
        /// </summary>
        public override bool Read() => _reader.Read();

        /// <summary>
        /// Asynchronously advances the <see cref="EDBDataReader"/> to the next record.
        /// </summary>
        public override Task<bool> ReadAsync(CancellationToken cancellationToken) =>
            _reader.ReadAsync(cancellationToken);

        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="EDBDataReader"/>.
        /// </summary>
        public override IEnumerator GetEnumerator() => _reader.GetEnumerator();

        /// <summary>
        /// Releases the resources used by the <see cref="EDBDataReader"/> and optionally releases the managed resources.
        /// </summary>
