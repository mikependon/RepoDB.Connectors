...
namespace RepoDb.Connector.CockroachDb
{
    ...
    /// </summary>
    public class CockroachDbException : DbException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbException"/> class.
        /// </summary>
        /// <param name="exception">The underlying <see cref="NpgsqlException"/> to wrap.</param>
        internal CockroachDbException(NpgsqlException exception)
