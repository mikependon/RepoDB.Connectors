...
{
    /// <summary>
    /// Represents a parameter to a <see cref="CockroachDbCommand"/>.
    /// </summary>
    public class CockroachDbParameter : DbParameter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbParameter"/> class.
        /// </summary>
        public CockroachDbParameter()
        {
            _parameter = new NpgsqlParameter();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbParameter"/> class from an existing <see cref="NpgsqlParameter"/>.
        /// </summary>
        /// <param name="parameter">The underlying <see cref="NpgsqlParameter"/> to wrap.</param>
        internal CockroachDbParameter(NpgsqlParameter parameter)
        {
        ...
        /// <summary>
        /// Gets or sets the <see cref="CockroachDbType"/> of the parameter.
        /// </summary>
        public CockroachDbType CockroachDbType
        {
            get => CockroachDbTypeConverter.ToCockroachDbType(_parameter.NpgsqlDbType);
            set => _parameter.NpgsqlDbType = CockroachDbTypeConverter.ToNpgsqlDbType(value);
        }
