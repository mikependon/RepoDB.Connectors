...
namespace RepoDb.Connector.CockroachDb.Bulk
{
    ...
    /// </summary>
    public class CockroachDbBulkCopy : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbBulkCopy"/> class using the specified connection string.
        /// </summary>
        /// <param name="connectionString">The connection string used to open the destination database.</param>
        public CockroachDbBulkCopy(
            string connectionString)
            : this(new CockroachDbConnection(connectionString))
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbBulkCopy"/> class using the specified <see cref="CockroachDbConnection"/>.
        /// </summary>
        /// <param name="connection">The <see cref="CockroachDbConnection"/> to the destination database.</param>
        public CockroachDbBulkCopy(
            CockroachDbConnection connection)
        {
            ColumnMappings = new CockroachDbBulkCopyColumnMappingCollection();
        ...
        /// </summary>
        public CockroachDbBulkCopyColumnMappingCollection ColumnMappings { get; private set; }
        ...
        /// <summary>
        /// Releases the resources used by the <see cref="CockroachDbBulkCopy"/>.
        /// </summary>
        ...
        {
            int ResolveSourceOrdinal(CockroachDbBulkColumnMapping mapping) => reader.GetOrdinal(mapping.SourceColumn);
        ...
        public async Task<int> WriteToServerAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            int ResolveSourceOrdinal(CockroachDbBulkColumnMapping mapping) => table.Columns.IndexOf(mapping.SourceColumn);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            int ResolveSourceOrdinal(CockroachDbBulkColumnMapping mapping) =>
        ...
        private async Task<int> ExecuteAsync(
            Func<CockroachDbBulkColumnMapping, int> resolveSourceOrdinal,
            ...
            CancellationToken cancellationToken)
        {
            ...
            foreach (CockroachDbBulkColumnMapping mapping in ColumnMappings)
            {
