...
namespace RepoDb.Connector.CockroachDb
{
    ...
    /// </summary>
    public class CockroachDbDataReader : DbDataReader
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbDataReader"/> class.
        /// </summary>
        /// <param name="reader">The underlying <see cref="NpgsqlDataReader"/> to wrap.</param>
        internal CockroachDbDataReader(NpgsqlDataReader reader)
        {
            _reader = reader;
        }
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="CockroachDbDataReader"/> contains one or more rows.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of fields in the <see cref="CockroachDbDataReader"/> that are not hidden.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="DataTable"/> that describes the column metadata of the <see cref="CockroachDbDataReader"/>.
        /// </summary>
        ...
        /// <summary>
        /// Advances the <see cref="CockroachDbDataReader"/> to the next record.
        /// </summary>
        public override bool Read() => _reader.Read();

        /// <summary>
        /// Asynchronously advances the <see cref="CockroachDbDataReader"/> to the next record.
        /// </summary>
        public override Task<bool> ReadAsync(CancellationToken cancellationToken) =>
            _reader.ReadAsync(cancellationToken);

        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="CockroachDbDataReader"/>.
        /// </summary>
        public override IEnumerator GetEnumerator() => _reader.GetEnumerator();

        /// <summary>
        /// Releases the resources used by the <see cref="CockroachDbDataReader"/> and optionally releases the managed resources.
        /// </summary>
