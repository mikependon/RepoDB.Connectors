...
namespace RepoDb.Connector.CockroachDb
{
    ...
    /// </summary>
    public class CockroachDbConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbConnectionStringBuilder"/> class.
        /// </summary>
        public CockroachDbConnectionStringBuilder()
        {
            _builder = new NpgsqlConnectionStringBuilder();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="CockroachDbConnectionStringBuilder"/> class with the given connection string.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        public CockroachDbConnectionStringBuilder(string connectionString)
        {
        ...
        /// <summary>
        /// Gets or sets the connection string associated with this <see cref="CockroachDbConnectionStringBuilder"/>.
        /// </summary>
