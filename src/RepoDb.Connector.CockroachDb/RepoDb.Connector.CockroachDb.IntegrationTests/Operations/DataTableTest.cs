...
namespace RepoDb.Connector.CockroachDb.IntegrationTests.Operations
{
    ...
    public class DataTableTest
    {
        ...
        [TestMethod]
        public void TestCockroachDbDataTableLoadFromDataReader()
        {
        ...
        [TestMethod]
        public void TestCockroachDbDataTableLoadFromDataReaderCreatesMatchingColumns()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbDataTableLoadFromDataReaderWithNullValues()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbDataTableLoadFromDataReaderWithEmptyResultSet()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbDataTableLoadFromDataReaderWithMultipleResultSets()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbDataTableLoadFromDataReaderTwiceMergesRows()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task TestCockroachDbDataTableLoadFromDataReaderAsync()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbDataTableLoadFromClosedDataReaderIsNoOp()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
