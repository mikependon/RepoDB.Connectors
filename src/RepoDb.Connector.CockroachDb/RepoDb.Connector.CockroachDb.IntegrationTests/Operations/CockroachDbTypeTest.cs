...
namespace RepoDb.Connector.CockroachDb.IntegrationTests.Operations
{
    ...
    /// (see <see cref="Setup.Database.CreateInsertTable"/>) through <see cref="CockroachDbCommand"/> /
    /// <see cref="CockroachDbDataReader"/>, verifying both the value and the CLR type reported for each column.
    /// </summary>
    [TestClass]
    public class CockroachDbTypeTest
    {
        [TestInitialize]
        ...
        private static CockroachDbDataReader InsertAndRead(
        ...
        [TestMethod]
        public void TestCockroachDbTypeForIdColumn()
        {
        ...
        [TestMethod]
        public void TestCockroachDbTypeForRowGuidColumn()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnBit()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnBitWhenNull()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnDateTime()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnDateTimeWhenNull()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnDateTime2()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnDateTime2WhenNull()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnDecimal()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnDecimalWhenNull()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnFloat()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnFloatWhenNull()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnInt()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnIntWhenNull()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnNVarChar()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
                var expected = "CockroachDbTypeTest 日本語 Ünïcödé";
                connection.Open();
        ...
        [TestMethod]
        public void TestCockroachDbTypeForColumnNVarCharWhenNull()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockroachDbTypeForAllInsertModelColumnsRoundTrip()
        {
            using (var connection = new CockroachDbConnection(Database.ConnectionString))
            {
                // Setup
