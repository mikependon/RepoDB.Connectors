...
namespace RepoDb.Connector.CockcroachDb.IntegrationTests.Operations
{
    ...
    public class ExecuteScalarTest
    {
        ...
        [TestMethod]
        public void TestCockcroachDbExecuteScalarTest()
        {
        ...
        [TestMethod]
        public void ThrowOnCockcroachDbExecuteScalarWithInvalidTable()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    Assert.Throws<CockcroachDbException>(() => command.ExecuteScalar());
                }
            }
        }

        [TestMethod]
        public void ThrowOnCockcroachDbExecuteScalarWithInvalidSyntax()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task TestCockcroachDbExecuteScalarAsyncTest()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task ThrowOnCockcroachDbExecuteScalarAsyncWithInvalidTable()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
                ...
                {
                    command.CommandText = commandText;
                    await Assert.ThrowsAsync<CockcroachDbException>(() => command.ExecuteScalarAsync());
                }
            }
        }

        [TestMethod]
        public async Task ThrowOnCockcroachDbExecuteScalarAsyncWithInvalidSyntax()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
