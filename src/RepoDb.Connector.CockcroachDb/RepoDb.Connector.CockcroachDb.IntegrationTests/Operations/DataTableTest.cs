...
namespace RepoDb.Connector.CockcroachDb.IntegrationTests.Operations
{
    ...
    public class DataTableTest
    {
        ...
        [TestMethod]
        public void TestCockcroachDbDataTableLoadFromDataReader()
        {
        ...
        [TestMethod]
        public void TestCockcroachDbDataTableLoadFromDataReaderCreatesMatchingColumns()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
                ...
                {
                    Assert.Contains(expectedColumn, table.Columns.Cast<DataColumn>().Select(column => column.ColumnName), StringComparer.Ordinal);
                }
        ...
        [TestMethod]
        public void TestCockcroachDbDataTableLoadFromDataReaderWithNullValues()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbDataTableLoadFromDataReaderWithEmptyResultSet()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
                ...
                Assert.Contains("ColumnNVarChar", table.Columns.Cast<DataColumn>().Select(column => column.ColumnName), StringComparer.Ordinal);
            }
        }

        [TestMethod]
        public void TestCockcroachDbDataTableLoadFromDataReaderWithMultipleResultSets()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbDataTableLoadFromDataReaderTwiceMergesRows()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task TestCockcroachDbDataTableLoadFromDataReaderAsync()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbDataTableLoadFromClosedDataReaderIsNoOp()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
