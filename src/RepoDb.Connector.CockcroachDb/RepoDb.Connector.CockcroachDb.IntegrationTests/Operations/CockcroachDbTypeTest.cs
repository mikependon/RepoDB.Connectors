...
namespace RepoDb.Connector.CockcroachDb.IntegrationTests.Operations
{
    ...
    /// (see <see cref="Setup.Database.CreateInsertTable"/>) through <see cref="CockcroachDbCommand"/> /
    /// <see cref="CockcroachDbDataReader"/>, verifying both the value and the CLR type reported for each column.
    /// </summary>
    [TestClass]
    public class CockcroachDbTypeTest
    {
        [TestInitialize]
        ...
        private static CockcroachDbDataReader InsertAndRead(
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForIdColumn()
        {
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForRowGuidColumn()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnBit()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnBitWhenNull()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnDateTime()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnDateTimeWhenNull()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnDateTime2()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnDateTime2WhenNull()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnDecimal()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnDecimalWhenNull()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnFloat()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnFloatWhenNull()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnInt()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnIntWhenNull()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnNVarChar()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
                var expected = "CockcroachDbTypeTest 日本語 Ünïcödé";
                connection.Open();
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForColumnNVarCharWhenNull()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestCockcroachDbTypeForAllInsertModelColumnsRoundTrip()
        {
            using (var connection = new CockcroachDbConnection(Database.ConnectionString))
            {
                // Setup
