...
{
    /// <summary>
    /// Specifies the native CockroachDB column type of a <see cref="CockcroachDbParameter"/> or result column, in addition to the standard ADO.NET <see cref="System.Data.DbType"/>.
