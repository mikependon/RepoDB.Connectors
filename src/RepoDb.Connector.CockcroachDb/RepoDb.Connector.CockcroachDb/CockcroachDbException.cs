...
{
    /// <summary>
    /// The exception that is thrown when CockroachDB returns an error.
    /// </summary>
    public class CockcroachDbException : DbException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbException"/> class.
        /// </summary>
        /// <param name="exception">The underlying <see cref="NpgsqlException"/> to wrap.</param>
        internal CockcroachDbException(NpgsqlException exception)
