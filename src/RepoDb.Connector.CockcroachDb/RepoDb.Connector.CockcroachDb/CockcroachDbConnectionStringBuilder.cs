...
namespace RepoDb.Connector.CockcroachDb
{
    ...
    /// </summary>
    public class CockcroachDbConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbConnectionStringBuilder"/> class.
        /// </summary>
        public CockcroachDbConnectionStringBuilder()
        {
            _builder = new NpgsqlConnectionStringBuilder();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbConnectionStringBuilder"/> class with the given connection string.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        public CockcroachDbConnectionStringBuilder(string connectionString)
        {
        ...
        /// <summary>
        /// Gets or sets the connection string associated with this <see cref="CockcroachDbConnectionStringBuilder"/>.
        /// </summary>
