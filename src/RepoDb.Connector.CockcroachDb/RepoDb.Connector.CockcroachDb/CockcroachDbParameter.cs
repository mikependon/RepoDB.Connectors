...
{
    /// <summary>
    /// Represents a parameter to a <see cref="CockcroachDbCommand"/>.
    /// </summary>
    public class CockcroachDbParameter : DbParameter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbParameter"/> class.
        /// </summary>
        public CockcroachDbParameter()
        {
            _parameter = new NpgsqlParameter();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbParameter"/> class from an existing <see cref="NpgsqlParameter"/>.
        /// </summary>
        /// <param name="parameter">The underlying <see cref="NpgsqlParameter"/> to wrap.</param>
        internal CockcroachDbParameter(NpgsqlParameter parameter)
        {
        ...
        /// <summary>
        /// Gets the underlying <see cref="NpgsqlParameter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="CockcroachDbType"/> of the parameter.
        /// </summary>
        public CockcroachDbType CockcroachDbType
        {
            get => CockcroachDbTypeConverter.ToCockcroachDbType(_parameter.NpgsqlDbType);
            set => _parameter.NpgsqlDbType = CockcroachDbTypeConverter.ToNpgsqlDbType(value);
        }
