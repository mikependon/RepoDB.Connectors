...
{
    /// <summary>
    /// Lets you efficiently bulk load a CockroachDB table with data from another source.
    /// </summary>
    public class CockcroachDbBulkCopy : IDisposable
    {
        private readonly CockcroachDbConnection _connection;

        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbBulkCopy"/> class using the specified connection string.
        /// </summary>
        /// <param name="connectionString">The connection string used to open the destination database.</param>
        public CockcroachDbBulkCopy(
            string connectionString)
            : this(new CockcroachDbConnection(connectionString))
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbBulkCopy"/> class using the specified <see cref="CockcroachDbConnection"/>.
        /// </summary>
        /// <param name="connection">The <see cref="CockcroachDbConnection"/> to the destination database.</param>
        public CockcroachDbBulkCopy(
            CockcroachDbConnection connection)
        {
            ColumnMappings = new CockcroachDbBulkCopyColumnMappingCollection();
        ...
        /// </summary>
        public CockcroachDbBulkCopyColumnMappingCollection ColumnMappings { get; private set; }
        ...
        /// <summary>
        /// Releases the resources used by the <see cref="CockcroachDbBulkCopy"/>.
        /// </summary>
        ...
        {
            int ResolveSourceOrdinal(CockcroachDbBulkColumnMapping mapping) => reader.GetOrdinal(mapping.SourceColumn);
        ...
        public async Task<int> WriteToServerAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            int ResolveSourceOrdinal(CockcroachDbBulkColumnMapping mapping) => table.Columns.IndexOf(mapping.SourceColumn);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            int ResolveSourceOrdinal(CockcroachDbBulkColumnMapping mapping) =>
        ...
        private async Task<int> ExecuteAsync(
            Func<CockcroachDbBulkColumnMapping, int> resolveSourceOrdinal,
            ...
            CancellationToken cancellationToken)
        {
            ...
            foreach (CockcroachDbBulkColumnMapping mapping in ColumnMappings)
            {
                ...
                if (string.IsNullOrEmpty(destinationColumn))
                {
                    ...
                    if (mapping.DestinationOrdinal < 0 || mapping.DestinationOrdinal >= destinationColumns.Count)
                    {
                        throw new IndexOutOfRangeException(
                            string.Create(CultureInfo.InvariantCulture, $"Destination ordinal {mapping.DestinationOrdinal} is out of range for table '{DestinationTableName}', which has {destinationColumns.Count} column(s)."));
                    }
