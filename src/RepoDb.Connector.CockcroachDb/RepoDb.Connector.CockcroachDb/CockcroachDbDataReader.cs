...
{
    /// <summary>
    /// Provides a means of reading a forward-only stream of rows from a CockroachDB database.
    /// </summary>
    public class CockcroachDbDataReader : DbDataReader
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CockcroachDbDataReader"/> class.
        /// </summary>
        /// <param name="reader">The underlying <see cref="NpgsqlDataReader"/> to wrap.</param>
        internal CockcroachDbDataReader(NpgsqlDataReader reader)
        {
            _reader = reader;
        }
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="CockcroachDbDataReader"/> contains one or more rows.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of fields in the <see cref="CockcroachDbDataReader"/> that are not hidden.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="DataTable"/> that describes the column metadata of the <see cref="CockcroachDbDataReader"/>.
        /// </summary>
        ...
        /// <summary>
        /// Advances the <see cref="CockcroachDbDataReader"/> to the next record.
        /// </summary>
        public override bool Read() => _reader.Read();

        /// <summary>
        /// Asynchronously advances the <see cref="CockcroachDbDataReader"/> to the next record.
        /// </summary>
        public override Task<bool> ReadAsync(CancellationToken cancellationToken) =>
            _reader.ReadAsync(cancellationToken);

        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="CockcroachDbDataReader"/>.
        /// </summary>
        public override IEnumerator GetEnumerator() => _reader.GetEnumerator();

        /// <summary>
        /// Releases the resources used by the <see cref="CockcroachDbDataReader"/> and optionally releases the managed resources.
        /// </summary>
