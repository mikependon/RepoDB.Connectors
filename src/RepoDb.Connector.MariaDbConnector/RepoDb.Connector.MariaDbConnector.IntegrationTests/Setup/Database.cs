...
namespace RepoDb.Connector.MariaDbConnector.IntegrationTests.Setup
{
    /// <summary>
    ...
    public static class Database
    {
        ...
        public static void Initialize()
        {
            ...
            ConnectionString =
                ...
                "Server=127.0.0.1;Port=3307;Database=RepoDb.Connector.MariaDbConnector;User ID=root;Password=RepoDB2026;AllowLoadLocalInfile=True;AllowUserVariables=True;";
        ...
        public static void CreateDatabase()
        {
            ...
            Helper.ExecuteNonQuery(connection, "CREATE DATABASE IF NOT EXISTS `RepoDb.Connector.MariaDbConnector`;");
        }
