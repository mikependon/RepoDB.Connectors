...
{
    /// <summary>
    /// Represents a parameter to a <see cref="AuroraDbCommand"/>.
    /// </summary>
    public class AuroraDbParameter : DbParameter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuroraDbParameter"/> class.
        /// </summary>
        public AuroraDbParameter()
        {
            _parameter = new NpgsqlParameter();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="AuroraDbParameter"/> class from an existing <see cref="NpgsqlParameter"/>.
        /// </summary>
        /// <param name="parameter">The underlying <see cref="NpgsqlParameter"/> to wrap.</param>
        internal AuroraDbParameter(NpgsqlParameter parameter)
        {
        ...
        /// <summary>
        /// Gets or sets the <see cref="AuroraDbType"/> of the parameter.
        /// </summary>
