...
namespace RepoDb.Connector.AuroraDb.Npgsql.Bulk
{
    /// <summary>
    /// Lets you efficiently bulk load a AuroraDB table with data from another source.
    /// </summary>
    public class AuroraDbBulkCopy : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuroraDbBulkCopy"/> class using the specified connection string.
        /// </summary>
        /// <param name="connectionString">The connection string used to open the destination database.</param>
        public AuroraDbBulkCopy(
            string connectionString)
            : this(new AuroraDbConnection(connectionString))
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="AuroraDbBulkCopy"/> class using the specified <see cref="AuroraDbConnection"/>.
        /// </summary>
        /// <param name="connection">The <see cref="AuroraDbConnection"/> to the destination database.</param>
        public AuroraDbBulkCopy(
        ...
        /// </summary>
        public AuroraDbBulkCopyColumnMappingCollection ColumnMappings { get; private set; }
        ...
        /// <summary>
        /// Releases the resources used by the <see cref="AuroraDbBulkCopy"/>.
        /// </summary>
        ...
        public async Task<int> WriteToServerAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            int ResolveSourceOrdinal(AuroraDbBulkColumnMapping mapping) => table.Columns.IndexOf(mapping.SourceColumn);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            int ResolveSourceOrdinal(AuroraDbBulkColumnMapping mapping) =>
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                // The binary COPY protocol is Npgsql specific, hence the underlying (currently active) NpgsqlConnection of the AWS wrapper is used.
