...
namespace RepoDb.Connector.AuroraDb.IntegrationTests.Operations
{
    ...
    public class DataTableTest
    {
        ...
        [TestMethod]
        public void TestAuroraDbDataTableLoadFromDataReader()
        {
        ...
        [TestMethod]
        public void TestAuroraDbDataTableLoadFromDataReaderCreatesMatchingColumns()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbDataTableLoadFromDataReaderWithNullValues()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbDataTableLoadFromDataReaderWithEmptyResultSet()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbDataTableLoadFromDataReaderWithMultipleResultSets()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbDataTableLoadFromDataReaderTwiceMergesRows()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task TestAuroraDbDataTableLoadFromDataReaderAsync()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbDataTableLoadFromClosedDataReaderIsNoOp()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
