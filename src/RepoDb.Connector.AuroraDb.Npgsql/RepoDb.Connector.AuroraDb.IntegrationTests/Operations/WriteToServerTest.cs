...
namespace RepoDb.Connector.AuroraDb.IntegrationTests.Operations
{
    ...
    public class WriteToServerTest
    {
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerTest()
        {
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithSourceColumnAndDestinationColumnMappings()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithSourceOrdinalAndDestinationColumnMappings()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithSourceColumnAndDestinationOrdinalMappings()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithSourceOrdinalAndDestinationOrdinalMappings()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void ThrowOnAuroraDbBulkCopyWriteToServerWithOutOfRangeDestinationOrdinal()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithDataRowArray()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithDataRowArraySubset()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithEmptyDataRowArray()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithNullDataRowArray()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithDataTableAddedRowState()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithDataTableModifiedRowState()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestAuroraDbBulkCopyWriteToServerWithDataTableUnchangedRowState()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
