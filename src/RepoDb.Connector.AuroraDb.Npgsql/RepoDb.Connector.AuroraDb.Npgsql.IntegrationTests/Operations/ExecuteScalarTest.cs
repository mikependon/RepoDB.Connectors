...
namespace RepoDb.Connector.AuroraDb.Npgsql.IntegrationTests.Operations
{
    ...
    public class ExecuteScalarTest
    {
        ...
        [TestMethod]
        public void TestAuroraDbExecuteScalarTest()
        {
        ...
        [TestMethod]
        public void ThrowOnAuroraDbExecuteScalarWithInvalidTable()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    Assert.Throws<AuroraDbException>(() => command.ExecuteScalar());
                }
            }
        }

        [TestMethod]
        public void ThrowOnAuroraDbExecuteScalarWithInvalidSyntax()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task TestAuroraDbExecuteScalarAsyncTest()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task ThrowOnAuroraDbExecuteScalarAsyncWithInvalidTable()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
                ...
                {
                    command.CommandText = commandText;
                    await Assert.ThrowsAsync<AuroraDbException>(() => command.ExecuteScalarAsync());
                }
            }
        }

        [TestMethod]
        public async Task ThrowOnAuroraDbExecuteScalarAsyncWithInvalidSyntax()
        {
            using (var connection = new AuroraDbConnection(Database.ConnectionString))
            {
                // Setup
