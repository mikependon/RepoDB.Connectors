...
namespace RepoDb.Connector.AuroraDb.MySqlConnector.IntegrationTests.Setup
{
    /// <summary>
    /// A class used as a startup setup for the RepoDb AuroraDb bulk-operations test database.
    /// </summary>
    public static class Database
    {
        ...
        /// <summary>
        /// Gets the connection string used to reach the Aurora MySQL server itself (the <c>sys</c> database) -
        ...
        /// <summary>
        /// Gets the connection string to be used for the AuroraDb database.
        /// </summary>
        ...
        public static void Initialize()
        {
            ConnectionStringForSystem =
                Environment.GetEnvironmentVariable("REPODB_AURORADB_MYSQL_CONSTR_SYSTEM") ??
                "Server=127.0.0.1;Port=3308;Database=sys;User ID=root;Password=RepoDB2026;";

            ConnectionString =
                Environment.GetEnvironmentVariable("REPODB_AURORADB_MYSQL_CONSTR") ??
                "Server=127.0.0.1;Port=3308;Database=RepoDb.Connector.AuroraDb.MySqlConnector;User ID=root;Password=RepoDB2026;AllowLoadLocalInfile=True;AllowUserVariables=True;";
        ...
        public static void CreateDatabase()
        {
            ...
            Helper.ExecuteNonQuery(connection, "CREATE DATABASE IF NOT EXISTS `RepoDb.Connector.AuroraDb.MySqlConnector`;");
        }
