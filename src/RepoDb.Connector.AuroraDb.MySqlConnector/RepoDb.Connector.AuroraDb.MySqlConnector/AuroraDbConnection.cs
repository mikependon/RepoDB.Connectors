...
{
    /// <summary>
    /// Represents a connection to an Amazon Aurora MySQL database.
    ...
    /// Secrets Manager, ...) on top of the underlying <see cref="MySqlConnection"/>.
    /// </summary>
    public class AuroraDbConnection : DbConnection
    {
        private readonly AwsWrapperConnection<MySqlConnection> _connection;

        #region Constructors

        /// <summary>
        /// Registers the AWS MySqlConnector dialect, required by the AWS wrapper before MySqlConnector can be used with it.
        /// </summary>
        ...
        /// The connection string can hold both the MySqlConnector and the AWS wrapper (e.g. <c>Plugins</c>) connection properties.
        /// </summary>
        ...
        {
            _connection = new AwsWrapperConnection<MySqlConnection>(connectionString);
        }
        ...
        /// </summary>
        internal AwsWrapperConnection<MySqlConnection> InnerConnection => _connection;
