...
{
    /// <summary>
    /// The exception that is thrown when Aurora MySQL returns an error.
    /// It wraps the <see cref="MySqlException"/> or the <see cref="AwsWrapperDbException"/> raised by the underlying provider.
    ...
    public class AuroraDbException : DbException
    {
        ...
        /// </summary>
        /// <param name="exception">The underlying <see cref="MySqlException"/> or <see cref="AwsWrapperDbException"/> to wrap.</param>
        ...
        /// </summary>
        public override int ErrorCode => _exception is MySqlException mySqlException ? mySqlException.Number : _exception.ErrorCode;

        /// <summary>
        /// Gets a number that identifies the type of error (the MySQL error number).
        /// </summary>
