...
{
    /// <summary>
    /// Represents a SQL statement to execute against a Aurora MySQL database.
    /// </summary>
    public class AuroraDbCommand : DbCommand
    {
        ...
        {
            _command = new AwsWrapperCommand<MySqlCommand>();
            _parameters = new AuroraDbParameterCollection((MySqlParameterCollection)_command.Parameters);
        }
        ...
        public AuroraDbCommand(
            string commandText)
        {
            _command = new AwsWrapperCommand<MySqlCommand>(commandText);
            _parameters = new AuroraDbParameterCollection((MySqlParameterCollection)_command.Parameters);
        }
        ...
        /// </summary>
        /// <param name="commandText">The text of the query.</param>
        /// <param name="connection">A <see cref="AuroraDbConnection"/> that represents the connection to a Aurora MySQL server.</param>
        public AuroraDbCommand(
            string commandText,
            AuroraDbConnection connection)
        {
            _command = new AwsWrapperCommand<MySqlCommand>(commandText, connection.InnerConnection);
            _parameters = new AuroraDbParameterCollection((MySqlParameterCollection)_command.Parameters);
        ...
        public override void Cancel()
        {
            ...
            catch (DbException exception) when (exception is MySqlException || exception is AwsWrapperDbException)
            {
        ...
        /// <summary>
        /// Creates a prepared version of the command on an instance of Aurora MySQL server.
        /// </summary>
        ...
        protected override DbParameter CreateDbParameter()
        {
            try
            {
                return new AuroraDbParameter((MySqlParameter)_command.CreateParameter());
            }
            catch (DbException exception) when (exception is MySqlException || exception is AwsWrapperDbException)
            {
                throw new AuroraDbException(exception);
        ...
        /// <summary>
        /// Ensures that a <see cref="AuroraDbConnection"/> has been assigned to this command, and is open, before it gets executed.
        /// </summary>
