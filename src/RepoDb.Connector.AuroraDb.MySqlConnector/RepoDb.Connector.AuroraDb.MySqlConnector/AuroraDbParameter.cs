...
namespace RepoDb.Connector.AuroraDb.MySqlConnector
{
    ...
    public class AuroraDbParameter : DbParameter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuroraDbParameter"/> class from an existing <see cref="MySqlParameter"/>.
        /// </summary>
        /// <param name="parameter">The underlying <see cref="MySqlParameter"/> to wrap.</param>
        internal AuroraDbParameter(MySqlParameter parameter)
        {
        ...
        {
            get => AuroraDbTypeConverter.ToAuroraDbType(_parameter.MySqlDbType);
            set => _parameter.MySqlDbType = AuroraDbTypeConverter.ToMySqlDbType(value);
        }
