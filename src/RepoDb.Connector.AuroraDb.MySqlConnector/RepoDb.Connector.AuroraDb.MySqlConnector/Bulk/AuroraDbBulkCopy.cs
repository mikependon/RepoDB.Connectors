...
namespace RepoDb.Connector.AuroraDb.MySqlConnector.Bulk
{
    /// <summary>
    /// Lets you efficiently bulk load a Aurora MySQL table with data from another source.
    /// </summary>
    public class AuroraDbBulkCopy : IDisposable
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var bulkCopy = new MySqlBulkCopy(_connection.InnerConnection.Unwrap<MySqlConnection>(), null)
                {
