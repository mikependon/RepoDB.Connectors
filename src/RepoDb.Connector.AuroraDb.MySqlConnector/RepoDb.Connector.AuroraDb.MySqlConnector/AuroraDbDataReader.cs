...
{
    /// <summary>
    /// Provides a means of reading a forward-only stream of rows from a Aurora MySQL database.
    /// </summary>
    public class AuroraDbDataReader : DbDataReader
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuroraDbDataReader"/> class.
        /// </summary>
        /// <param name="reader">The underlying <see cref="AwsWrapperDataReader"/> to wrap.</param>
        internal AuroraDbDataReader(DbDataReader reader)
        {
            _reader = reader;
        }
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="AuroraDbDataReader"/> contains one or more rows.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of fields in the <see cref="AuroraDbDataReader"/> that are not hidden.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="DataTable"/> that describes the column metadata of the <see cref="AuroraDbDataReader"/>.
        /// </summary>
        ...
        /// <summary>
        /// Advances the <see cref="AuroraDbDataReader"/> to the next record.
        /// </summary>
        public override bool Read() => _reader.Read();

        /// <summary>
        /// Asynchronously advances the <see cref="AuroraDbDataReader"/> to the next record.
        /// </summary>
        public override Task<bool> ReadAsync(CancellationToken cancellationToken) =>
            _reader.ReadAsync(cancellationToken);

        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="AuroraDbDataReader"/>.
        /// </summary>
        public override IEnumerator GetEnumerator() => _reader.GetEnumerator();

        /// <summary>
        /// Releases the resources used by the <see cref="AuroraDbDataReader"/> and optionally releases the managed resources.
        /// </summary>
